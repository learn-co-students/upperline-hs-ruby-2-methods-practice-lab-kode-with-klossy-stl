...
def trip_length
	"The trip will take #{156*3} seconds."# here
end
...
def pay_dancers
  "The dancers were paid #{1.5*23} dollars"
end
...
"Everything is Awesome! Everything is Awesome! Everything is Awesome! Everything is Awesome! Everything is Awesome!"
